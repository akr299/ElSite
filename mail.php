...
$site_top = "http://192.168.11.172:5500/index.php"; //本番適用時変更

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "bookreader0299@gmail.com";
...
<form action="<?php echo ("http://192.168.11.172:5500/mail.php"); ?>" method="POST">
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://el-ltd.co.jp" target="_blank">- el.co.,ltd -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
